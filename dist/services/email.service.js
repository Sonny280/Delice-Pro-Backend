...
exports.envoyerEmailBienvenue = exports.envoyerEmailCode2FA = exports.envoyerEmailReset = void 0;
...
exports.envoyerEmailReset = envoyerEmailReset;
// ── 2. Code 2FA ───────────────────────────────────────────────────────────────
const envoyerEmailCode2FA = async (email, prenom, code) => {
    try {
        await resend.emails.send({
            from: FROM, to: email,
...
exports.envoyerEmailCode2FA = envoyerEmailCode2FA;
// ── 3. Bienvenue ──────────────────────────────────────────────────────────────
const envoyerEmailBienvenue = async (email, prenom, entreprise, motDePasse) => {
    try {
        await resend.emails.send({
            from: FROM, to: email,
...
exports.envoyerEmailBienvenue = envoyerEmailBienvenue;
