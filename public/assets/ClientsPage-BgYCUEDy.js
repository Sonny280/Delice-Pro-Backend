import{a as et,u as tt,r as g,j as e,l as ye,F as Se,S as Le,C as ge,X as rt,A as st,d as A,z as E}from"./index-Bp6JSanT.js";import{a as Ie,b as xe,B as h,K as O,d as Ae,C as De,M as V}from"./index-cMdleCNK.js";import{A as it,P as Ue,M as ot}from"./phone-BwHKs7sa.js";import{P as Oe}from"./pencil-Dq_ALJgK.js";import{P as J}from"./plus-Cs1w5P0L.js";import{C as Fe}from"./clipboard-list-B0Fx0U-9.js";import{R as qe,U as pe}from"./user-CdtOOoL8.js";import{F as Me}from"./factory-h950K_Nu.js";import{T as Ve}from"./trash-2-CplsYF9q.js";import{B as be}from"./building-2-CvVjHLWr.js";const F={RECUE:{label:"Reçue",type:"info",next:"EN_PRODUCTION",action:"Lancer en production"},EN_PRODUCTION:{label:"En production",type:"warn",next:"PRETE",action:"Marquer prête"},PRETE:{label:"Prête",type:"ok",next:"LIVREE",action:"Marquer livrée"},LIVREE:{label:"Livrée",type:"neutral",next:null},ANNULEE:{label:"Annulée",type:"err",next:null}};function Be(i,c,r){const p=C=>`${Number(C).toLocaleString("fr-FR")} ${(r==null?void 0:r.devise)??"F"}`,R=new Date(i.dateLivraison).toLocaleDateString("fr-FR",{weekday:"long",day:"numeric",month:"long",year:"numeric"}),j=new Date().toLocaleDateString("fr-FR",{day:"numeric",month:"long",year:"numeric"}),P=i.montantTotal-i.acompte,f=(i.lignes??[]).map(C=>{var D;return`
    <tr>
